...
export default function PriceComparison() {
  ...
  const [data, setData] = useState([
    { store: "Woolworths", storeLogo: "/store-logos/woolworths.svg", price: 0.00, lastUpdated: "2025-01-29T15:30:00.000Z" },
    { store: "IGA", storeLogo: "/store-logos/iga.svg", price: 1.00, lastUpdated: "2025-02-25T15:30:00.000Z" },
    { store: "Coles", storeLogo: "/store-logos/coles.svg", price: 2.00, lastUpdated: "2025-01-12T15:30:00.000Z" },
    { store: "Aldi", storeLogo: "/store-logos/aldi.svg", price: 3.00, lastUpdated: "2025-03-16T15:30:00.000Z" }
  ]);
